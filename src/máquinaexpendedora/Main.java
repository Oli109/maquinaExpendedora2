...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        sube1_PrecioCabezaGuisadoJuanAntonio2223(snack);
        
        sube2_PrecioCabezaGuisadoJuanAntonio2223(snack);
        
        obtener1_UnidadesCabezaGuisadoJuanAntonio2223(snack);
        
        obtener2_UnidadesCabezaGuisadoJuanAntonio2223(snack);
        
        obtener3_UnidadesCabezaGuisadoJuanAntonio2223(snack);
        
    }

    public static void obtener3_UnidadesCabezaGuisadoJuanAntonio2223(MáquinaExpendedora snack) {
    ...
    public static void obtener2_UnidadesCabezaGuisadoJuanAntonio2223(MáquinaExpendedora snack) {
    ...
    public static void obtener1_UnidadesCabezaGuisadoJuanAntonio2223(MáquinaExpendedora snack) {
    ...
    public static void sube2_PrecioCabezaGuisadoJuanAntonio2223(MáquinaExpendedora snack) {
    ...
    public static void sube1_PrecioCabezaGuisadoJuanAntonio2223(MáquinaExpendedora snack) {
